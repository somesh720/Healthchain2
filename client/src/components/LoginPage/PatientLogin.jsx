...
const PatientLogin = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (res.ok) {
        // Expect data.patient to exist with _id and fullName (or name)
        ...
        localStorage.setItem("patientAge", patient.age || "N/A");
        localStorage.setItem(
          "patientGender",
          patient.gender || "Not specified"
        );
        localStorage.setItem("patientBloodGroup", patient.bloodgroup || "");
